	...
	class WooCommerce_PDF_Invoices_Writepanels {
		...
		public function add_listing_actions( $order ) {
			$listing_actions = array(
				...
				'dist-invoice'		=> array (
					'url'		=> wp_nonce_url( admin_url( 'admin-ajax.php?action=generate_wpo_wcpdf&template_type=dist-invoice&order_ids=' . $order->id ), 'generate_wpo_wcpdf' ),
					'img'		=> WooCommerce_PDF_Invoices::$plugin_url . 'images/invoice.png',
					'alt'		=> __( 'PDF Distributor Invoice', 'wpo_wcpdf' ),
				),
				'packing-slip'	=> array (
