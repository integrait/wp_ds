...
if ( !class_exists( 'WooCommerce_PDF_Invoices' ) ) {
	...
	class WooCommerce_PDF_Invoices {
		...
		public function get_woocommerce_totals() {
			...
			// if($url[2] != "my-account"){ 
			// 	$commission = get_post_meta($this->export->order->id, '_ds_commission', true); 
			// 	$commission2 = ($commission != "")? "N ".number_format($commission, 2): "N 0.00"; 
			// 	$net_total = ($commission != "")? "N ". number_format((float)($this->export->order->get_total() - $commission), 2) : "N ".number_format($this->export->order->get_total(), 2);
