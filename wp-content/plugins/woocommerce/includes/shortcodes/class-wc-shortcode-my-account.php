...
class WC_Shortcode_My_Account {
	...
	public static function retrieve_password() {
		...
		//Start Hacking for custom reset password email by SODIMU Segun | by Vektor Viper
		//*************************************************************************************************************
		//*************************************************************************************************************
		//*************************************************************************************************************
		//*************************************************************************************************************
		
		$message2 =  network_site_url("wp-login.php?action=rp&key=$key&login=" . rawurlencode($user_login), 'login') . "\r\n";
		ob_start();
		?>
		
		<p>Hi <?php echo $user_data->display_name; ?></p>
		<p>You requested that the password be reset for the following account: </p> 
        	<p> Username: <b><?php echo $user_login; ?></b></p> 
        	<p> E-mail: <b><?php echo $user_email; ?></b></p>
		...
		<a href="<?php echo $message2; ?>">Reset My Password</a><br/>
		<p>Thanks,<br/>DrugStoc Team.</p>
		<p>Tel: +2348096879999<br/>Email: info@drugstoc.com</p>
		...
		$headers .= 'From: DrugStoc <support@drugstoc.biz>'."\r\n";    
	
		mail($user_email,'Password Reset Request', $content, $headers);  

		//hack by Vektor Viper| Sodimu Segun 
