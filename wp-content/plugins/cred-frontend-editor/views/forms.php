...
<div class="wrap">
    ...
    <h2><?php _e('CRED Forms', 'wp-cred'); ?><a class="add-new-h2" href="<?php echo $url; ?>"><?php _e('Add New', 'wp-cred'); ?></a>
    ...
    $(function(){
        ...
        $('form#list').on('click','a.submitdelete',function(event){
            ...
            cred.gui.Popups.confirm({
                message:'<?php echo esc_js(__( "Are you sure that you want to delete this form?", "wp-cred" )); ?>',
                class: 'cred-dialog',
        ...
        $('form#list').submit(function(event){
            ...
            if (action=='export-selected')
            {
                ...
                $.fileDownload('<?php echo CRED_CRED::route('/Forms/exportSelected?ajax=1'); ?>',{
                    successCallback:function() {
            ...
            else if (action=='delete-selected')
            {
                ...
                cred.gui.Popups.confirm({
                    message:'<?php echo esc_js(__( "Are you sure that you want to delete the selected forms?", "wp-cred" )); ?>',
                    class: 'cred-dialog',
                    buttons: [cred.settings.locale.Yes, cred.settings.locale.No],
                    primary: cred.settings.locale.Yes,
                    callback: function(button) {
