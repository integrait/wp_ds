...
class CRED_Custom_Fields_List_Table extends WP_List_Table implements CRED_Singleton
{
    ...
    */ 
    function get_columns() 
    {
        ...
        'cred_cred_type'=>__('CRED Field Type', 'wp-cred'),
    ...
    */
    ...
    { 
        ...
        foreach($records as $rec)
        {
            ...
            // set api ajax paths
            $setfieldpath = CRED_CRED::route('/Generic_Fields/getCustomField'.'?post_type='.$this->_post_type.'&field_name='.$rec.'&TB_iframe=true&width=600&height=450');
            $editfieldpath = CRED_CRED::route('/Generic_Fields/getCustomField'.'?post_type='.$this->_post_type.'&field_name='.$rec.'&TB_iframe=true&width=600&height=450');
            $removefieldpath = CRED_CRED::route('/Generic_Fields/removeCustomField'.'?post_type='.$this->_post_type.'&field_name='.$rec);
	            ...
	            switch ( $column_name ) {   
                    ...
                    case "cred_actions": 
                        $actions=array(
                            ...
                            '<a style="margin-right:10px" class="cred-field-actions _cred-field-remove" href="'.$removefieldpath.'" title=\''.esc_attr(__('Remove this field as a CRED field type','wp-cred')).'\'>'.__('Remove','wp-cred').'</a>',
                        );
