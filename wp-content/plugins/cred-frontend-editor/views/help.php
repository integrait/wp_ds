...
<p><?php
printf(
    __( 'For retrieving debug information if asked by a support person, use the <a href="%s">debug information</a> page.', 'wp-cred' ),
    admin_url('admin.php?page=cred-debug-information')
);
?></p>
