...
*/
    ...
    $._mvvm__suggest = function(input, options) {
        ...
        {
            if (CRED.suggest_cache===false) return false;
            var i, l;
    ...
    {
        if (!key.substring) return undefined;
                    ...
                    'show' : function($el, data) {
                        ...
                        if (data['condition'])
                        {
                            ...
                            if (undefined!==data['condition'])
                            {
                                if (data['condition'])
                                    action='show';
                                else action='hide'; //?$el.show():$el.hide();
                            }
                        }
                        else
                        {
                        ...
                        if (delay)
                        {
                            if ('show'==action)
                                ...
                                setTimeout(function(){$el.hide();}, delay);
                        }
                        else
                        {
                            if ('show'==action)
                    ...
                    'hide' : function($el, data) {
                        ...
                        if (data['condition'])
                        {
                            ...
                            if (undefined!==data['condition'])
                            {
                                if (data['condition'])
                                    action='hide';
                                else action='show'; //?$el.show():$el.hide();
                ...
                Prototype : {
                    ...
                    _doInitAction : function($els, data) {
                        ...
                        $els.each( function() {
                            ...
                            // no init action
                            if ( !bind || !bind.event || 'init'!=bind.event || !bind.action ) return;
                    ...
                    get : function($el, att) {
                        ...
                        if (!this._memoize) this._memoize={};
