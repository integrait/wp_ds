(function (window, $, cred, undefined)
{
    ...
    var self, edit_url=cred.settings.editurl, form_controller_url=cred.settings.form_controller_url, wizard_url=cred.settings.wizard_url, newform;
    ...
    function submithandler(event)
    {
        ...
        if (cred.doCheck())
        {
            $.ajax({
                ...
                data:'form_id='+form_id+'&field=wizard'+'&value='+self.completed_step,
                type: 'post',
