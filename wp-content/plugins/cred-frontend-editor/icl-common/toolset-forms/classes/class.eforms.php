 ...
 *
 * $HeadURL: https://www.onthegosystems.com/misc_svn/common/tags/cred-1.3.3/toolset-forms/classes/class.eforms.php $
...
//    }
    ...
    public function renderElement($element)
    {
        ...
        if (is_callable(array($this, $method))) {
             ...
             */
            if ( is_admin() && wpcf_wpml_field_is_copied($element) ) {
