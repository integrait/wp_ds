...
if (!function_exists('adodb_mktime')) {
	require_once CRED_PLUGIN_PATH . '/icl-common/toolset-forms/lib/adodb-time.inc.php';
}
		...
		?>
                <tr>
                    <td colspan=2>
                        ...
                        <span><?php _e('Enable Automatic Expiration of Post options for CRED forms', $this->_localization_context); ?></span></label>
                    </td>
                </tr>
		<?php
	}
