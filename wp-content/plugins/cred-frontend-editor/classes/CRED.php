...
/**
 *
 * $HeadURL: https://www.onthegosystems.com/misc_svn/crud/tags/1.3.3/classes/CRED.php $
 * $LastChangedDate: 2014-09-17 12:09:21 +0000 (Wed, 17 Sep 2014) $
 * $LastChangedRevision: 27222 $
...
final class CRED_CRED
{
   ...
   public static function saveFormCustomFields($post_id, $post)
   {
        ...
        if (isset($_POST['_cred']) && is_array($_POST['_cred']) && !empty($_POST['_cred']))
        {
            ...
            if (!empty($extra_js)) $extra_js = wp_kses($extra_js, $allowed_tags,  $allowed_protocols);            
