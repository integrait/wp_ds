...
*
 * $HeadURL: https://www.onthegosystems.com/misc_svn/crud/tags/1.3.3/classes/common/XML_Processor.php $
 * $LastChangedDate: 2014-07-17 14:09:58 +0000 (Thu, 17 Jul 2014) $
 * $LastChangedRevision: 25065 $
    ...
    private static function importAttachedMedia($id, $media, $_tmp, $_tmpuri)
    {
        ...
        if (count($media)>0&&!isset($media[0]))
        {
            ...
            )
            {
                ...
                $att_data = array();
                if ( isset( $attach['post_title'] ) ) $att_data['post_title'] = $attach['post_title'];
                if ( isset($attach['post_content'] ) ) $att_data['post_content'] = $attach['post_content'];
                if ( isset($attach['post_excerpt'] ) ) $att_data['post_excerpt'] = $attach['post_excerpt'];
                if ( isset($attach['post_status'] ) ) $att_data['post_status'] = $attach['post_status'];
