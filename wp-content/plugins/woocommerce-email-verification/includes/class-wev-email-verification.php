...
class WEV_Email_Verification{
	...
	public function send_verification($to, $un, $pw, $hash){
		...
		$message .= '<br/><br/>Yours sincerely,<br/>'.$blogname.' Team';

		// Add Notice - Check your mail
		//wc_add_notice('Your registration was successful. To use your account, follow the activation link sent to your mail.');
