<?php
  ...
  $no = (strlen(p) > 6) ? $p : 'Unavailable';
?>
<span id="revealnumber" data-reveal="<?php echo $no;?>" style="cursor: pointer;"><img style="width: 20px;" src="<?php echo home_url();?>/wp-content/themes/sistina/images/phone-512.png">View Phone Number</span>
