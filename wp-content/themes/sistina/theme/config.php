...
define( 'YIT_SAMPLE_IMAGES_URL', 'https://dl.dropbox.com/s/odga3ogq3bh79ok/sistina.zip' );
...
if( !defined( 'YIT_SHOW_PANEL_HEADER' ) ) { define( 'YIT_SHOW_PANEL_HEADER', 1 ); }
if( !defined( 'YIT_SHOW_PANEL_HEADER_LINKS' ) ) { define( 'YIT_SHOW_PANEL_HEADER_LINKS', 1 ); }
