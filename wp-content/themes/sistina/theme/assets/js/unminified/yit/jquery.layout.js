...
jQuery(document).ready(function($){
    ...
    var show_dropdown = function( elem )
    {
        if( $(this).attr('class') ) { elem = $(this); }
        ...
        $('ul.sub-menu:not(ul.sub-menu li > div.submenu > ul.sub-menu), ul.children:not(ul.children li > div.submenu > ul.children)', elem).parent().css(options).stop(true, true).fadeIn(300);
    }

    var hide_dropdown = function( elem )
    {
        if( $(this).attr('class') ) { elem = $(this); }
        $('ul.sub-menu:not(ul.sub-menu li > div.submenu > ul.sub-menu), ul.children:not(ul.children li > div.submenu > ul.children)', elem).parent().fadeOut(300);
    }
