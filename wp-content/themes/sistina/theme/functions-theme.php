...
function yit_search_filter($query) {
    if( !isset( $_GET['post_type'] ) ) { return $query; }
...
function yit_string_translation() {
    /**
     * Set a javascript object wich have translation string as properties
     *
     * @author   Andrea Frascaspata  <andrea.frascaspata@yithemes.com>
     *
     * @param $context
     ...
     * @since    1.6.0
     */
    wp_localize_script( 'jquery', 'yit_translate', array(
        'added' =>  __( 'ADDED', 'yit' ),
    ));
