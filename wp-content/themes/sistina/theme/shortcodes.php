...
function yit_add_shortcodes( $shortcodes ) {
    ...
    $shortcodes['section']['attributes']['portfolio_icon_title'] = array(
        'title' => __('Title icon URL', 'yit'),
        'type' => 'text',
        'desc' => __( 'Select the icon to use for the title.', 'yit' ),
        'std'  => ''
    ...
    $shortcodes['section_blog']['attributes']['blog_icon_title'] = array(
        'title' => __('Title icon URL', 'yit'),
        'type' => 'text',
        'desc' => __( 'Select the icon to use for the title.', 'yit' ),
        'std'  => ''
    ...
    $shortcodes['section']['attributes']['blog_show_hover'] = array(
        'title' => __('Enable hover', 'yit'),
        'type' => 'checkbox',
        'std'  => 'yes'
    );
    $shortcodes['section_blog']['attributes']['blog_show_hover'] = array(
        'title' => __('Enable hover', 'yit'),
        'type' => 'checkbox',
        'std'  => 'yes'
    );
