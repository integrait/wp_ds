...
//yit_enqueue_style( 1, 'reset-bootstrap', YIT_CORE_ASSETS_URL . '/css/reset-bootstrap.css', false, '1.0', 'all' );
//yit_enqueue_style( 2, 'style-css', get_bloginfo( 'stylesheet_url' ), array('reset-bootstrap'), '1.0', 'all' );
...
if( is_child_theme() && file_exists( get_stylesheet_directory() . '/js/jquery.custom.js' ) ) {
    wp_enqueue_script( 'jquery-custom', get_stylesheet_directory_uri() . '/js/jquery.custom.js' , array( 'jquery' ), rand(999, 9999), true );
} else {
    wp_enqueue_script( 'jquery-custom', get_template_directory_uri() . '/js/jquery.custom.js' , array( 'jquery' ), rand(999, 9999), true );
}
