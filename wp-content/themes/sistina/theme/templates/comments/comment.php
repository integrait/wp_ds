...
<li <?php comment_class( yit_comment_has_children( $comment->comment_ID ) ? ' parent' : '' ); ?> id="li-comment-<?php comment_ID(); ?>">
    <div class="<?php echo 'offset' . ( $depth - 1 ) . ' span' . ( 10 - yit_comment_depth( get_comment_ID() ) ) ?>">
        <div id="comment-<?php comment_ID(); ?>" class="comment-container">
            <div class="row">
                <div class="comment-author vcard span2<?php echo $isAuthorPostClass;?>">
                ...
                <div class="comment-meta commentmetadata reply comment-author-name comment-date span2">
                    ...
                    <div class="date-reply-link">
                        ...
                        <a class="date" href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ); ?>">
                            ...
                            printf( __( 'on %1$s', 'yit' ), get_comment_date( 'M j, Y' ) ); ?></a>
                ...
                <div class="comment-content span<?php echo 6 - $depth ?>">
