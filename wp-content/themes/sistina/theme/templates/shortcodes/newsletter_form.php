...
$submit = !empty( $submit ) ? $submit : yit_get_option( 'newsletter-submit-label' );  
    ...
    $html .= '<div class="newsletter-section group">';
        ...
        $html .= '<form method="' . $method . '" action="' . $action . '" class="contact-form">';
        
            $html .= '<fieldset>'; 
            
                $html .= '<ul class="group">';
            
                    $html .= '<li class="text-field">';
                    //$html .= '<label for="' . $email . '">' . $email_label . '</label>';
                    $html .= '<input type="text" name="' . $email . '" id="' . $email . '" class="email-field text-field" placeholder="' . $email_label . '" />';
                    $html .= '</li>';     
                    ...
                    $html .= '<input type="submit" value="' . $submit . '" class="sendmail alignright" />';
                    $html .= '</li>';
