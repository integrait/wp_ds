	...
	if( !$('#primary').hasClass('sidebar-no') ) {
		...
		$('.content').removeClass('span9').addClass('span12');
 				...
 				<div class="row">
                        ...
                        <li <?php yit_work_class( $classes ) ?>>
                            ...
                            <?php if ( ! empty( $image_url ) ) : ?>
							  	<div class="picture_overlay">
							  		<?php yit_image( "id=$image_id&size=" . apply_filters( 'yit-thumb_portfolio_columns-image', "thumb_portfolio_{$columns}cols" ) . "&alt=portfolioimage" );//echo wp_get_attachment_image( $image_id, "thumb_portfolio_{$columns}cols" ); ?>
                    ...
                    <?php yit_portfolio_pagination('', 1) ?>
               </div>
