                     <?php $layout = (yit_work_get( 'layout' ) != '') ? yit_work_get( 'layout' ) : 'small' ?>
    						                        ...
    						                        <?php if ( empty( $extra_images ) ) : ?> 
										                <div class="work-thumbnail">                                                                                                                           
														  	<div class="<?php if ( !$lightbox ) : ?>picture_overlay_empty <?php endif ?>picture_overlay">
														  		<?php yit_image( "id=$image_id&size=" . apply_filters( 'yit-thumb_portfolio_fulldesc-image', 'thumb_portfolio_fulldesc' ) );//echo wp_get_attachment_image( $image_id, 'thumb_portfolio_fulldesc' ); ?>
						...
						<h3 class="related"><?php echo yit_portfolio_get_setting( 'other_projects_label', $current_portfolio ) ?></h3>
						<div class="portfolio-full-description-related-projects row">
							...
							<?php foreach( $portfolios as $item_id => $item ): ?>
								...
								<div class="<?php if( (++$i % 6 == 0) ): ?>related_project_last <?php endif ?>related_project span3">
                            		...
                            		$title    = yit_work_get( 'event_title_other_projects' );
                            		if( $lightbox && $details ) {
                            			$both  = 1;
									  	...
									  	<div class="picture_overlay">
									  		...
									  		<div class="overlay">
									  			<div>
									  				...
									  				<p>
														<?php if( $lightbox ): ?><a href="<?php $thumb ?>" rel="lightbox" class="ch-info-lightbox<?php if($video_url): ?>-video<?php endif ?>"><img src="<?php echo get_template_directory_uri() . '/images/icons/' .  ($video_url  ? 'play.png' : 'zoom.png') ?>" alt="<?php _e('Open Lightbox', 'yit') ?>" /></a><?php endif ?>
