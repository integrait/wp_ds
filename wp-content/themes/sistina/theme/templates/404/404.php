...
if( !yit_get_option( '404-custom' ) ) : ?>
    <?php if(yit_get_option('logo-url')): ?>
        <div class="error-404-logo">
            <img src="<?php echo yit_get_option('logo-url'); ?>" >
        </div>
    <?php endif; ?>
    ...
    <div class="error-404-text group">
        <h2><?php _e('Page not found', 'yit'); ?></h2>
        <p><?php printf( __( 'Go to the <a href="%s">home page</a> or use the search box below.', 'yit' ), home_url() ) ?></p>
    </div>
