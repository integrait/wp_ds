			...
			while ( $r->have_posts()) {
				...
				echo '<li>
					<a href="' . get_permalink() . '">
						' . ( has_post_thumbnail() ? get_the_post_thumbnail( $r->post->ID, 'shop_thumbnail' ) : ( ( function_exists( 'wc_placeholder_img' ) ) ? wc_placeholder_img( 'shop_thumbnail' ) : woocommerce_placeholder_img( 'shop_thumbnail' )) ) . ' ' . get_the_title() . '
