...
class faq_filters extends WP_Widget
{
    ...
    {                                                
		...
		?>
		<?php /*<p><a href="#all" data-option-value="*" class="all active"><?php _e('View all', 'yit') ?></a> <?php _e('or filter by:', 'yit') ?></p> */ ?>
        <?php /*<p><?php _e('filter by:', 'yit') ?></p>*/ ?>
		<?php
	    ...
	    if( !$faq->have_posts() ){ return false; } ?>
			<ul>
				<li><a href="#all" data-option-value="*" class="active"><?php echo apply_filters('yit_faq_filters_categories_all', __('ALL', 'yit')); ?></a></li>
