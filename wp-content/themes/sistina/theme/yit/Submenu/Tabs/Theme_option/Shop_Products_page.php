...
class YIT_Submenu_Tabs_Theme_option_Shop_Products_page extends YIT_Submenu_Tabs_Abstract {
    ...
    public function init() {  
        return apply_filters( strtolower( __CLASS__ ), array(
        	10 => array(
			...
			16 => array(
				'id'   => 'shop-hover-product',
				'type' => 'onoff',
				'name' => __( 'Activate hover effect on product image', 'yit' ),
				'desc' => __( 'Select if you want to show secondary image when hover over the product', 'yit' ),
				'std'  => true,
			),
            18 => array(
