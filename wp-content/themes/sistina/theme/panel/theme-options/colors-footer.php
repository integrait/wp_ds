...
function yit_submenu_tabs_theme_option_colors_footer( $items ) {
    ...
    unset( $items[10], $items[20], $items[30] );
        ...
        $items[10] = array(
            ...
            'std' => apply_filters( 'yit_background-footer_std', '#fbfbfb' ),
		...
		$items[110] = array(
                'id' => 'copyright-borders-color',
                'type' => 'colorpicker',
                'name' => __( 'Copyright border color', 'yit' ),
                'desc' => __( 'Select the color for the border on top of copyright.', 'yit' ),
                'std' => apply_filters( 'yit_copyright-borders-color_std', '#ebebeb' ),
                'style' => apply_filters( 'yit_copyright-borders-color_style', array(
                	'selectors' => '#copyright .container',
                	'properties' => 'border-color'				
            ) )
        );
        return $items;
...
add_filter( 'yit_footer-background_std', create_function( '', 'return "#fbfbfb";' ) );
add_filter( 'yit_copyright-background_std', create_function( '', 'return "#fbfbfb";' ) );