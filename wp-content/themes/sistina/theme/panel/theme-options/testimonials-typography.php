...
function yit_tab_testimonials_typography( $fields ) {
	...
	return array_merge( $fields, array(			
        ...
        31 => array(
            'id'   => 'testimonials-signature-font',
            'type' => 'typography',
            'name' => __( 'Text Testimonials signature font', 'yit' ),
            'desc' => __( 'Choose the font type, size and color.', 'yit' ),
            'min'  => 10,
            'max'  => 18,
            'std'  => apply_filters( 'yit_testimonials-signature-font_std', array(
                'size'   => 18,
                'unit'   => 'px',
            ...
            'style' => apply_filters( 'yit_testimonials-signature-font_style', array(
				'selectors' => '.testimonial-page-full .testimonial-signature p.signature',
				'properties' => 'font-size, font-family, color, font-style, font-weight'
			) )
        ),
        51 => array(
        ...
        60 => array(
            'id'   => 'testimonials-thumb-border-color',
            'type' => 'colorpicker',
            'name' => __( 'Testimonials thumbnails border color', 'yit' ),
            'desc' => __( 'Choose the thumbnails border color.', 'yit' ),
            'std'  => apply_filters( 'yit_testimonials-thumb-border-color_std', '#ef8801' ),
            'style' => apply_filters( 'yit_testimonials-thumb-border-color_style', array(
				'selectors' => '.testimonial-page-full .thumbnail img, .testimonial-page-full .thumbnail-quote',
