...
function yit_tab_colors_header( $fields ) {
    ...
    return array_merge( $fields, array(
        20 => array(
            'id' => 'header-below-border',
            'type' => 'colorpicker',
            'name' => __( 'Border bottom of header', 'yit' ),
            'desc' => __( 'Select the colour for the border bottom of header.', 'yit' ),
            'std' => apply_filters( 'yit_header-border_std', '#E8E8E8' ),
            'style' => apply_filters( 'yit_header-below-border_selectors', array(
                'selectors' => '#header .header-below',
        ...
        25 => array(
            'id' => 'header-below-bg',
            'type' => 'colorpicker',
            'name' => __( 'Background of slogan', 'yit' ),
            'desc' => __( 'Select the background colour of the slogan section, in the header.', 'yit' ),
            'std' => apply_filters( 'yit_header-border_std', '#F6F4F4' ),
            'style' => apply_filters( 'yit_header-below-border_selectors', array(
                'selectors' => '#header .header-below',
        ...
        30 => array(
            ...
            'std' => apply_filters( 'yit_background-header_std', '#fbfbfb' ),
