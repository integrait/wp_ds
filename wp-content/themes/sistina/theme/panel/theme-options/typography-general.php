...
function yit_slogan_font_style( $array ) {
    $array['selectors'] = '#header .slogan h2';
    return $array;
}
...
add_filter( 'yit_links-font_std', create_function( '', 'return "#e89222";' ) );
add_filter( 'yit_links-font-hover_std', create_function( '', 'return "#e37a1c";' ) );
...
function yit_heading1_font_std( $array ) { $array['size'] = 24; return $array; }
add_filter( 'yit_h1-font_std', 'yit_heading1_font_std' );

function yit_heading2_font_std( $array ) { $array['size'] = 22; return $array; }
...
function yit_h6_font_style( $array ) {
    $array['selectors'] .= ',.section-services-bandw .service-wrapper .service h4 a';
    return $array;
}
add_filter( 'yit_h6-font_style', 'yit_h6_font_style' );