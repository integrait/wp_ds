...
function yit_tab_general_settings( $fields ) {
    ...
    $fields[140] = array(
        'id'   => 'enable-sidebar-dropdown',
        'type' => 'onoff',
        'name' => __( 'Enable dropdown in sidebar widgets', 'yit' ),
        'desc' => __( 'Enable this option to display a show/hide button for each widget in sidebar', 'yit' ),
        'std'  => 1
    );
