...
function yit_tab_typography_navigation( $fields ) {
        return array(
            10 => array(
                ...
                'style' => array(
					'selectors' => '#nav ul li, #nav ul li a, #nav .megamenu ul.sub-menu li.menu-item-custom-content p, #nav ul li, #nav ul li a span.special-font, #nav .megamenu ul.sub-menu li.menu-item-custom-content p span.special-font, #header-right-content, .welcome_user a, .wpml a, .cart-items',
            ...
            11 => array(
                ...
                'std'  => apply_filters( 'yit_navigation-text-font-hover_std', '#b1690c' ),
                'style' => array(
					'selectors' => '#nav ul li a:hover, #nav li:hover > a, #nav ul li a:hover span, #nav li:hover > a span, .welcome_username:hover a, .wpml:hover a, .wpml a:hover, .cart-items:hover',
					'properties' => 'color'
				)
            ),
            12 => array(
                ...
                'std'  => apply_filters( 'yit_navigation-text-font-active_std', '#b1690c' ),
                'style' => array(
            ...
            20 => array(
                ...
                'style' => array(
					'selectors' => '#nav ul li ul li a, #nav .megamenu ul.sub-menu li li a, #nav ul li ul li a span.special-font, #nav .megamenu ul.sub-menu li li a span.special-font, div.wpml #lang_sel_list a, .welcome_username div.welcome_menu a',
					'properties' => 'font-size, font-family, color, font-style, font-weight'
				)
            ),
            21 => array(
                ...
                'style' => array(
					'selectors' => '#nav ul li ul li a:hover, #nav .megamenu ul.sub-menu li li a:hover, #nav ul li ul li a:hover span, #nav .megamenu ul.sub-menu li li a:hover span, div.wpml #lang_sel_list a:hover, .welcome_username div.welcome_menu a:hover',
					'properties' => 'color'
				)
            ),
            22 => array(
