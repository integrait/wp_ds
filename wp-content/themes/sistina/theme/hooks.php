...
add_filter( 'pre_get_posts', 'yit_search_filter' );
...
add_action( 'yit_header', 'yit_header_below', 20 );
add_action( 'yit_header_skin', 'yit_header_skin', 10 );
add_action( 'yit_header_search_box', 'yit_header_search_box', 10 );
add_action( 'yit_header_below', 'yit_slider_section', 10 );
add_action( 'yit_header_below', 'yit_slogan', 20 );
...
add_action( 'wp_enqueue_scripts', 'yit_string_translation', 100 );
