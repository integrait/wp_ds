...
<li itemprop="reviews" itemscope itemtype="http://schema.org/Review" <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
    <div id="comment-<?php comment_ID(); ?>" class="comment_container">
        ...
        <?php echo get_avatar( $GLOBALS['comment'], apply_filters( 'woocommerce_review_gravatar_size', '60' ) ); ?>
        ...
        <div class="comment-text">
            ...
            <?php else : ?>
                <p class="meta">
                    ...
                    ?>&ndash; <time itemprop="datePublished" content="<?php echo get_comment_date('Y-m-d'); ?>" time datetime="<?php echo get_comment_date('c'); ?>"><?php echo get_comment_date(__( get_option('date_format'), 'yit' )); ?></time>:
                </p>
            <?php endif; ?>
