...
?>
    ...
    <div id="payment">
            ...
            <?php
                ...
                if ( ! empty( $available_gateways ) ) {
                    ...
                    if ( ! $woocommerce->customer->get_country() )
                        echo '<p>' . __( 'Please fill in your details above to see available payment methods.', 'yit' ) . '</p>';
                    else
                        echo '<p>' . __( 'Sorry, it seems that there are no available payment methods for your state. Please contact us if you require assistance or wish to make alternate arrangements.', 'yit' ) . '</p>';
        ...
        <?php if( !yit_get_option('shop-checkout-multistep') ): ?>
            <?php yith_wc_get_template('checkout/form-place-order.php', array('woocommerce' => $woocommerce)); ?>
        <?php endif ?>
