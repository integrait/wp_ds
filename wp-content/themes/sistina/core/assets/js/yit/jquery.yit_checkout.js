    ...
    $.yit_checkout.prototype = {
        ...
        _initLabels : function() {
            ...
            buttons.each(function(){
                $(this).data({
                    billing: $(this).val(),
                    shipping: $(this).attr('data-alternativelabel')
                });
            });
        },
        ...
        _updateBillingShippingLabels : function( value ) {
            ...
            if (value) {
                ...
                setStepLabels(next_step,next_step.data('billing'),next_step.data('shipping'));
                ...
                setStepLabels(next_step,next_step.data('shipping'),next_step.data('billing'));
...
function setStepLabels(obj_step,step1,step2){
    var step_label_value= (yit_woocommerce.woocommerce_ship_to_billing=="1") ? step1 : step2;
    obj_step.val(step_label_value);
}
