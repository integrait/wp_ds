 ...
 * @since 1.0.0
 */
function yit_register_portfolio_script( $portfolio_type, $handle, $asset = false ) {
 ...
 * @since 1.0
 */
function yit_get_portfolio_lenght() {
    return yit_get_model('portfolio')->get_length();
}
 ...
 * @since 1.0  
 */   
function yit_portfolio_pagination( $pages = false, $range = 10 ) {
    yit_get_model('portfolio')->get_pagination( $pages, $range );
}
