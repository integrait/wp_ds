    ...
    public function init() {  
        return array(        	
            ...
            10 => array(
                ...
                'style' => apply_filters( 'yit_h1-font_style', array(
					'selectors' => 'h1, h1 a',
					'properties' => 'font-size, font-family, color, font-style, font-weight'
				) )
            ),
            20 => array(
                ...
                'style' => apply_filters( 'yit_h2-font_style', array(
					'selectors' => 'h2, h2 a',
					'properties' => 'font-size, font-family, color, font-style, font-weight'
				) )
            ),
            30 => array(
                ...
                'style' => apply_filters( 'yit_h3-font_style', array(
					'selectors' => 'h3, h3 a',
					'properties' => 'font-size, font-family, color, font-style, font-weight'
				) )
            ),
            40 => array(
                ...
                'style' => apply_filters( 'yit_h4-font_style', array(
					'selectors' => 'h4, h4 a',
					'properties' => 'font-size, font-family, color, font-style, font-weight'
				) )
            ),
            50 => array(
                ...
                'style' => apply_filters( 'yit_h5-font_style', array(
					'selectors' => 'h5, h5 a',
					'properties' => 'font-size, font-family, color, font-style, font-weight'
				) )
            ),
            60 => array(
                ...
                'style' => apply_filters( 'yit_h6-font_style', array(
					'selectors' => 'h6, h6 a',
					'properties' => 'font-size, font-family, color, font-style, font-weight'
				) )
            ),
