...
class YIT_TinyMCE {
    ...
    public function __construct() {
        ...
        add_action('admin_action_yit-shortcodes-lightbox', array( $this, 'shortcodes_lightbox' ) );
    }
    ...
    public function shortcodes_lightbox() {
        include YIT_CORE_PATH . '/templates/admin/tinymce/lightbox.php';
    }
...
<?php
    ...
    public function media_buttons_context($context){      
        ...
        $out = '<a id="add_shortcode" style="display:none" href="'.admin_url('admin.php').'?action=yit-shortcodes-lightbox&post_id='.$iframe_ID.'&TB_iframe=1" class="hide-if-no-js thickbox" title="'. __("Add shortcode", 'yit').'"><img src="'.YIT_CORE_ASSETS_URL."/images/tinymce/icon_shortcodes.png".'" alt="'. __("Add Shortcode", 'yit') . '" /></a>';
        return $context . $out;
	}
