    ...
    <div class="step1_login_form span6">
        ...
        <form method="post" class="login_checkout">
            ...
            <p class="form-row">
                ...
                <input type="hidden" name="redirect" value="<?php echo get_permalink( yith_wc_get_page_id( 'checkout' ) ) ?>" />
...
<?php if ( get_option('woocommerce_enable_signup_and_login_from_checkout') == "no" ) return; ?>
