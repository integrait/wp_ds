...
/** 
 *
 * Custom  DB Utility Class for DrugStoc
 * 
 */ 
class DrugstocDB{ 
	// Live
	private $hostname_airops_con = "localhost";
	private $database_airops_con = "drugstoc_db_v1";
	private $username_airops_con = "drugstoc_integra";
	private $password_airops_con = "INTEGRA.1";	
	var $conn;	
	var $auth_token = 'jZ.<|xWE%-@)H%cX(d)[?fzVnG,*SV1|V=NofI&v #vl/B[T)B+U!.|0p{a,/l5}';
	...
	*
	* @param user input 
	* @return Response real_escape_string
	*/
